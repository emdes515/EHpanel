		...
		case "pl":
			localization =
			{
				...
				days: {
					...
					namesAbbr: ["Nie", "Pon", "Wto", "Śro", "Czw", "Pią", "Sob"],
					// shortest day names
					namesShort: ["Niedz", "Pn", "Wt", "Śr", "Czw", "Pt", "Sob"]
				},
				...
				decimalseparator: '.',
				thousandsseparator: ',',
				pagergotopagestring: "Idź do strony:",
				pagershowrowsstring: "Pokaż wiersze:",
				pagerrangestring: " z ",
				pagerpreviousbuttonstring: "poprzednie",
				pagernextbuttonstring: "następne",
				pagerfirstbuttonstring: "pierwsze",
				pagerlastbuttonstring: "ostatnie",
				groupsheaderstring: "Przeciągnij i upuść kolumnę tu do grupy według tej kolumny",
				sortascendingstring: "Sortowanie rosnące",
				sortdescendingstring: "Sortowanie malejące",
				sortremovestring: "Usuń sortowanie",
				groupbystring: "Grupuj wg. tej kolumny",
				groupremovestring: "Usuń w grupy",
				filterclearstring: "Wyczyść",
				filterstring: "Filtr",
				filtershowrowstring: "Pokaż wiersze jeśli:",
				filterorconditionstring: "Lub",
				filterandconditionstring: "I",
				filterselectallstring: "(Zaznacz wszystkie)",
				filterchoosestring: "Proszę wybrać:",
				filterstringcomparisonoperators: ['pusty', 'nie pusty', 'zawiera', 'zawiera(wielkość liter)',
				'nie zawiera', 'nie zawiera(wielkość liter)', 'rozpoczyna od', 'rozpoczyna od(wielkość liter)',
				'kończy na', 'kończy na(wielkość liter)', 'jest równy', 'jest równy(wielkość liter)', 'null', 'nie null'],
				filternumericcomparisonoperators: ['równy', 'różny', 'mniejszy od', 'mniejszy lub równy', 'większy od', 'większy lub równy', 'null', 'nie null'],
				filterdatecomparisonoperators: ['równy', 'różny', 'mniejszy od', 'mniejszy lub równy', 'większy od', 'większy lub równy', 'null', 'nie null'],
				filterbooleancomparisonoperators: ['równy', 'różny'],
				validationstring: "Wprowadzona wartość jest niepoprawna",
