$(document).ready(function () {
	...
	if (
		daneJSON['menu_zleceniaWewnetrzne_dzialZglaszajacy'].menu_zleceniaWewnetrzne_dzialZglaszajacy
	) {
		console.log($('#dashboardZleceniaWewnetrzneDzialyZglaszajacePulpit'));
	}
